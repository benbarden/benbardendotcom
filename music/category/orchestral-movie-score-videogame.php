<?php
    ...
    $pageTitle = 'Orchestral, Movie score, Videogame - Music by Ben Barden';
...
<div class="container">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Orchestral/Movie score/Videogame</li>
    </ul>

    <!-- Page Header -->
    <div class="row">
        <div class="col-md-12">
            <h1 class="page-header">Orchestral/Movie score/Videogame
...
?>
<script src="/assets/js/playlists/categories/orchestral-movie-score-videogame.js"></script>
<script>
