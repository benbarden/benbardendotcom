<?php
    ...
    $pageTitle = 'Upbeat, Dance, Modern - Music by Ben Barden';
...
<div class="container">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Upbeat/Dance/Modern</li>
    </ul>

    <!-- Page Header -->
    <div class="row">
        <div class="col-md-12">
            <h1 class="page-header">Upbeat/Dance/Modern
...
?>
<script src="/assets/js/playlists/categories/upbeat-dance-modern.js"></script>
<script>
