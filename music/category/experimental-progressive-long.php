<?php
    ...
    $pageTitle = 'Experimental, Progressive, Long - Music by Ben Barden';
...
<div class="container">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Experimental/Progressive/Long</li>
    </ul>

    <!-- Page Header -->
    <div class="row">
        <div class="col-md-12">
            <h1 class="page-header">Experimental/Progressive/Long
...
?>
<script src="/assets/js/playlists/categories/experimental-progressive-long.js"></script>
<script>
